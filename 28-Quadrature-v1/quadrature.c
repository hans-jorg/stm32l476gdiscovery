...
// Pullup for button
    GPIO_ConfigurePins(QUADRATURE_GPIO,QUADRATURE_BUTTON,GPIO_CONF_IN|GPIO_CONF_UP);
    GPIO_Write(QUADRATURE_GPIO,0,QUADRATURE_BUTTON);

// Pullup for quadrature inputs
    GPIO_ConfigurePins(QUADRATURE_GPIO,QUADRATURE_M,GPIO_CONF_IN);
...
uint32_t qread;
    ...
    qread = GPIO_Read(QUADRATURE_GPIO)&QUADRATURE_M;
...
uint32_t qread;
    ...
    qread = GPIO_Read(QUADRATURE_GPIO);
