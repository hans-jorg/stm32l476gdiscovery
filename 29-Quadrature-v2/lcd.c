...
/*
 * LCD Driver for GH08172T in STM32L476 Discovery Board
 *
 *
 */
...
/*
 * Configure GPIO Pins to be used by LCD module
 */
 ...
 * LCD Init
 *
 * Initialize LCD to use 24 segments and 4 controls (1/4 duty cycle)
 *
...
uint32_t t;
    ...
    /*
     * Reset LCD interface (really needed?)
     */
