...
/**
 * @brief Structure to store pointer to callback functions
 */
 ...
 *
 * @note  The pins X of all GPIO share the same interrupt vector EXTn
 */
//@{
 ...
 *
 * @note Initializes pins of GPIO used by Joystick as input and to generate
 *       interrupt every Low-to-High transition
 */
uint32_t
