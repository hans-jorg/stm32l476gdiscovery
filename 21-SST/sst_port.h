 ...
 * @date     23/01/2016
 *
 * @note     Obtained in https://github.com/upiitacode/SST_ARM
 *
 ******************************************************************************/
...
#define SST_MAX_PRIO     8              /* = 8 due to the size of Read List */

#include "stm32l476xx.h"      /* for declarations of __disable/enable_irq() */
